...
const quickLinks = [
  { text: "About Us", href: "#" },
  { text: "AI Technologies", href: "#ai-types" },
  { text: "Case Studies", href: "#ai-benefits" },
       ...
       <div className="app-container">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-12">
          ...
          <div className='space-y-4'>
            ...
            <p className="footer-description">
              Pioneering AI solutions for tomorrow's challenges. We empower businesses with cutting-edge artificial intelligence.
            </p>
            {/*Socail media links */}
         ...
         <div>
          ...
          <div>
            ...
            <p className="footer-newsletter-privacy">We respect your privacy. Unsubscribe at any time.</p>
          </div>
